...
class PositionProjector(ContinuousProjector):
    """Projects spatial features: dx_to_c4, dy_to_c4, dz, vel_x, vel_y. Input: 5d."""
...
class OrientProjector(ContinuousProjector):
    """Projects orientation: yaw_cos, yaw_sin, pitch. Input: 3d."""
...
class StateProjector(ContinuousProjector):
    """Projects player state: health_norm, armor_norm, money_norm. Input: 3d."""
...
class CoverProjector(ContinuousProjector):
    """Projects cover score from map layers. Input: 1d."""
